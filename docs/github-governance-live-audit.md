...
> public, המאגר talstilkol/connect והענף main. עדכון R177 מ־10.09.2026
> מחליף את חוזה v4 ב־v5 למסלול בעלים יחיד, עם PR ועשרה Checks מחייבים.
> דרישת Reviewer נוסף אינה פעילה במסלול זה; יתר הממצאים להלן היסטוריים.
