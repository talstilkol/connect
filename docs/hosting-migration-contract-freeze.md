...
| `security.distributed-rate-limits` | Cloudflare bindings + D1 ledger | Shared service | PostgreSQL tenant-mutation token bucket הושלם; נותרו System Admin ו־Webhook ingress, ערכי Policy חיים ו־Load evidence |
