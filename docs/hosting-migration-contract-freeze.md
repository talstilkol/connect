...
| `data.relational-database` | D1/SQLite | PostgreSQL | Transaction executor, ‏Node driver, חוזה Pool מאובטח ו־Foundation של 11 Adapters; Harness אמיתי עבר עם Contact/Conversation/Message/Template/Campaign DML ושני תרחישי Concurrency. Adapter הדוחות קיים אך שלוש טבלאות המקור הנותרות טרם הומרו; נותרו ספק וערכי Pool חיים, יתר ה־Repositories, ‏Parity מלאה מול 35 Migrations וראיות Staging |
