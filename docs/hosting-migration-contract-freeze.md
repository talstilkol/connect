...
| `data.relational-database` | D1/SQLite | PostgreSQL | Transaction executor, ‏Node driver, חוזה Pool מאובטח, ‏Foundation של 12 Adapters, ‏Readiness query ו־Runtime בעל סגירה מסודרת; Harness אמיתי עבר עם עשר Migrations, Contact organization service, ‏Contact import isolation, דוח HTTP מלא, ‏Contact/Conversation/Message/Template/Campaign/Bot/AI DML ושני תרחישי Concurrency. נותרו ספק וערכי Pool חיים, Adapter לייבוא אנשי קשר, יתר ה־Repositories, ‏Parity מלאה מול 35 Migrations וראיות Staging |
