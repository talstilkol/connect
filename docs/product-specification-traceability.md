...
| SPEC-27 | עברית, אנגלית וערבית | partial | Language domain ו־RTL foundation; דף הנחיתה, מעטפת Login/Register ומסך קבלת ההזמנה מתורגמים בשלוש השפות, כולל Metadata, נתיבי Auth מקומיים, Clerk localization, בורר הזמנה שאינו משכפל Key ו־Browser acceptance מקומי | תרגום Workspace ו־Admin; Browser acceptance לכל שפה ואימות Widget Clerk ותוצאות הזמנה חיות ב־Staging |
...
4.4.1 Slices דף הנחיתה, מעטפת Login/Register ומסך קבלת ההזמנה
בעברית, אנגלית וערבית הושלמו. להמשיך במסלול מסך־אחר־מסך עבור
Workspace ו־Admin ולאמת כל Surface בשלוש השפות. את Widget ה־Auth
ותוצאות ההזמנה החיות יש לאמת בנפרד ב־Staging מורשה.
