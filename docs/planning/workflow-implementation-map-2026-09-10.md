...
1.2 **מצב עדכני R221:** Knowledge/AI/Paddle, שחזור תוצאות לא ודאיות וניקוי מדיה לפי מדיניות ממומשים מקומית. נותרו חיבור מחדש עם הפרדת מחזורי סנכרון ובדיקת מסירה סופית. אלה שני תתי־שלבים באומדן 8–16 שעות הנדסה בביטחון נמוך. כל התהליכים עדיין דורשים קבלה חיה.
