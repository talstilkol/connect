...
12.2 עריכה לפני Binding, חידוש הרשאת קובץ אחרי עריכה, כיתוב מקורי של Echo חי, השלמת ייבוא וחידוש חיבור, S3/סריקה וקבלה מול ספק נשארים פתוחים. אין סגירה של W09/W10 או של שלב ראשי. נותרו 12 שלבים ראשיים; זמן ההשקה הכולל אינו ידוע.
