...
11.2 W09/W10 נשארים פתוחים: Echo חי עם כיתוב מקורי, placeholders, הרשאת קובץ לאחר עריכה, השלמת ייבוא וחידוש חיבור, וקבלה מול ספק עדיין דורשים השלמה. נותרו 12 שלבים ראשיים; זמן ההשקה הכולל אינו ידוע.
