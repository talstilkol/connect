...
**מצב נוכחי R223:** קריאת היסטוריה קודמת וקובץ שכבר נשמר ונסרק נתמכת לאחר Signup מאומת לאותו עסק ומספר, תוך שימור המקור וחסימת סירוב שיתוף. נותרו שיוך וייבוא אצוות ממחזורים נוספים וביקורת מסירה סופית: שני תתי־שלבים, 6–12 שעות הנדסה בביטחון נמוך. 12 שלבי ההשקה עדיין פתוחים.
