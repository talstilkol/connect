...
**עדכון R215:** נוספו שחזור Checkout לפי ראיות ותיקוני נעילות Bot. C3.2.5 ו־C4.1.4 עדיין בביצוע; יתר תתי־משימות הסגירה נשארות פתוחות. נותרו **6 תתי־משימות בשתי חבילות** ו־**12 שלבים ראשיים**. אומדן מעודכן לפי משימות: **12–24 שעות הנדסה בביטחון נמוך**, ללא מועד השקה מאומת. החיבורים בסיום התכנות. פירוט בסעיף 89 ובסעיף 10 של [תור הקוד](code-completion-plan-2026-09-11.md).
