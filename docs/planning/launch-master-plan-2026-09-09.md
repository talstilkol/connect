...
**עדכון R214:** ניהול מנוי ורכישה חוזרת הושלמו מקומית, בנוסף למדיניות הזכאות, AI, Knowledge ו־Checkout. נותרו **6 תתי־משימות בתוך 2 חבילות פיתוח ובדיקות**, וכן **12 שלבים ראשיים**. בירור תוצאות לא ודאיות וחמש משימות הסגירה התפעולית נשארו פתוחים. אומדן עבודה מתוקן: **12–24 שעות הנדסה**, בביטחון נמוך; אינו מועד השקה. החיבורים נדחים לסיום הקוד. פירוט בסעיף 88 ובסעיף 9 של [התור הפעיל](code-completion-plan-2026-09-11.md).
