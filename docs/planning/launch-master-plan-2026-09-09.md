...
4.1 כל טווח להלן הוא **שעות עבודה הנדסית שנותרו, לפני רזרבה**. האומדנים הם הערכה ראשונית של Codex לפי הקוד והתוכניות שנבדקו, ברמת ביטחון נמוכה־בינונית; הם אינם שעות שנמדדו. תתי־השלבים מסתכמים לשלב שלהם.
