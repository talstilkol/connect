...
**עדכון R213:** מדיניות זכאות ואכיפת פעולות בתשלום הושלמו מקומית, בנוסף ל־AI, Knowledge ו־Checkout. נותרו **8 תתי־משימות בתוך 2 חבילות פיתוח ובדיקות**, וכן **12 שלבים ראשיים**. ניהול מנוי, רכישה חוזרת ובירור תוצאות לא ודאיות עדיין פתוחים. בסיס האומדן: **16–32 שעות הנדסה**, בביטחון נמוך; אינו יתרה שנמדדה או מועד השקה. החיבורים נדחים לסיום הקוד. פירוט בסעיף 87 וב[תור הפעיל](code-completion-plan-2026-09-11.md).
