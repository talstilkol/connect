...
> **עדכון מחייב — 30.08.2026:** Tal הוא האחראי היחיד לכל עבודה
> פעילה. אין כרגע חלוקת Primary/Backup/RACI או הקצאה לאדם אחר.
> כל הקצאה ישנה במסמך זה מבוטלת ומוחלפת על ידי
> [מודל האחריות היחידני](planning/sole-owner-operating-model-2026-08-30.md).
> דרישה ל־Legal, Security או אישור ספק היא Evidence שטל מרכז, לא
> העברת בעלות על המשימה.
