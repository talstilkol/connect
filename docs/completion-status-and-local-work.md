...
נותרו רצפים שרירותיים של Conditions או שאלות, חיבור Graph מלא ובדיקות
Browser. האומדן המעודכן הוא **6–12 שעות**; עריכת חיבורים חופשית
וה־Browser E2E הם רוב אי־הוודאות שנותרה.
...
הוכרעו, הוא **44–74 שעות פיתוח נטו**. אם מאשרים את המודל המומלץ
בסעיף 18 של מסמך ההחלטות, הטווח התכנוני הופך ל־**52–88 שעות**.
