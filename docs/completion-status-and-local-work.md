...
נותרו חיבור החוזה לעורך ה־UI, חיבורי Canvas ובדיקות Browser. האומדן
המעודכן הוא **4–8 שעות**.
...
הוכרעו, הוא **42–70 שעות פיתוח נטו**. אם מאשרים את המודל המומלץ
בסעיף 18 של מסמך ההחלטות, הטווח התכנוני הופך ל־**50–84 שעות**.
