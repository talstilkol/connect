...
ה־Canvas החי מציג את כל ארבעת מבני הטיוטה והופרד מ־`BotFlowBuilder`;
לקורא מסך מוצג עץ סמנטי יחיד במקום הקראה כפולה של התרשים החזותי.
נותרו מסלולים מרובי Conditions או שאלות, חיבור Graph מלא ובדיקות
Browser. אומדן ה־8–16 שעות נשמר בשלב זה משום שעריכת חיבורים חופשית,
ריבוי הענפים וה־Browser E2E הם רוב אי־הוודאות שנותרה.
