...
Connections חזותית עם חצים. נותר Browser E2E. האומדן המעודכן הוא
**1–2 שעות**.
...
הוכרעו, הוא **39–64 שעות פיתוח נטו**. אם מאשרים את המודל המומלץ
בסעיף 18 של מסמך ההחלטות, הטווח התכנוני הופך ל־**47–78 שעות**.
