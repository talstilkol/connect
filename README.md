...
מצב הביצוע העדכני נמצא בסעיפי ההמשך של ה־Master Plan, עד סעיף 64. תוכנית
...
[מפת 21 תהליכי המוצר ופערי המימוש](docs/planning/workflow-implementation-map-2026-09-10.md)
מפרטת את מסכי ה־UI, פעולות השרת ומאגרי היעד, כולל חסמי קוד שנותרו לפני הפיילוט.
