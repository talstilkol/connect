...
import {
  ...
  readOutputRegistry,
  verifyEnvelope,
} from "../scripts/planning-discovery-cutoff-v2-lib.mjs";
...
test("v2 registry freezes the complete successor output denominator", async () => {
...
test("v2 cutoff and successor directories are separate", async () => {
  const registry = await readOutputRegistry();
  assert.notEqual(
