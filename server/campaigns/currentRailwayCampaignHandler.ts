...
import { createRailwayCampaignHandler } from "./railwayCampaignHandler.ts";
...
export function createCurrentRailwayCampaignHandler() {
  return createRailwayCampaignHandler({
