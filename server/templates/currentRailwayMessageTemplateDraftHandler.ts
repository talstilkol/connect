...
import { createRailwayMessageTemplateDraftHandler } from "./railwayMessageTemplateDraftHandler.ts";
...
export function createCurrentRailwayMessageTemplateDraftHandler() {
  return createRailwayMessageTemplateDraftHandler({
