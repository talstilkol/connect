...
import { createRailwayMessageTemplateDirectoryHandler } from "./railwayMessageTemplateDirectoryHandler.ts";
...
export function createCurrentRailwayMessageTemplateDirectoryHandler() {
  return createRailwayMessageTemplateDirectoryHandler({
