...
import {
  createRailwayMessageTemplateSyncHandler,
} from "./railwayMessageTemplateSyncHandler.ts";
...
export function createCurrentRailwayMessageTemplateSyncHandler() {
  return createRailwayMessageTemplateSyncHandler({
