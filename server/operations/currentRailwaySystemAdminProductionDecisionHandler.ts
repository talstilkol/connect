...
} from "./railwaySystemAdminProductionDecisionHandler.ts";
...
export function createCurrentRailwaySystemAdminProductionDecisionHandler() {
  return createRailwaySystemAdminProductionDecisionHandler({
