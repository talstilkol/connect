export const metaDataSyncViewStages = [
  ...
  "recovery-required", "connection-changed", "conflicted",
] as const;
...
export function parseMetaDataSyncView(value: unknown): Readonly<MetaDataSyncView> | null {
  ...
  if (["awaiting-worker", "awaiting-registration", "connection-changed", "sharing-declined", "conflicted"].includes(String(row.stage)) &&
