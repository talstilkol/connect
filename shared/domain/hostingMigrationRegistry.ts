...
export const HOSTING_MIGRATION_REGISTRY = Object.freeze([
  ...
  capability({
    ...
    sourceFiles: [
      ...
      "postgres/migrations/0058_meta_message_echo_revisions.sql",
      "postgres/migrations/0059_meta_contact_sync.sql",
      "postgres/migrations/0060_meta_data_sync_requests.sql",
      "postgres/migrations/0061_meta_history_sync.sql",
      "postgres/migrations/0062_meta_history_inbox_projection.sql",
      "postgres/migrations/0063_meta_account_lifecycle_evidence.sql",
    "postgres/migrations/0064_meta_signup_launches.sql",
    "postgres/migrations/0065_meta_data_sync_signup_binding.sql",
      "postgres/migrations/0066_meta_coexistence_sync_jobs.sql",
      "postgres/migrations/0067_meta_history_media_bindings.sql",
      "postgres/migrations/0068_meta_media_upload_journal.sql",
      "postgres/migrations/0069_meta_media_scan_observations.sql",
        "postgres/migrations/0070_meta_media_worker_tasks.sql",
        "postgres/migrations/0071_meta_media_inspection_retry.sql",
        "postgres/migrations/0072_meta_media_cleanup.sql",
        "postgres/migrations/0073_manual_reply_outbox.sql",
      "postgres/migrations/0074_meta_message_echo_captions.sql",
      "postgres/migrations/0075_meta_message_echo_original_captions.sql",
      "postgres/migrations/0076_ai_generation_journal.sql",
      "postgres/migrations/0077_ai_reply_deliveries.sql",
      "postgres/migrations/0078_knowledge_ingestion_jobs.sql",
      "postgres/migrations/0079_paddle_checkout_journal.sql",
      "postgres/migrations/0080_paddle_paid_access.sql",
      "postgres/migrations/0081_paddle_subscription_lifecycle.sql",
      "postgres/migrations/0082_paddle_checkout_recovery.sql",
      "postgres/migrations/0083_ai_publication_readiness.sql",
      "postgres/migrations/0084_paddle_operator_recovery.sql",
      "postgres/migrations/0085_knowledge_object_retention.sql",
      "postgres/migrations/0086_ai_generation_reconciliation.sql",
      "postgres/migrations/0087_ai_delivery_reconciliation.sql",
      "postgres/migrations/0088_knowledge_ingestion_reconciliation.sql",
      "postgres/migrations/0089_manual_delivery_reconciliation.sql",
      "postgres/migrations/0090_meta_media_retention.sql",
      "postgres/migrations/0091_meta_data_sync_generations.sql",
      "postgres/migrations/0092_meta_history_read_authorizations.sql",
      "postgres/migrations/0093_meta_history_generations.sql",
      "postgres/migrations/0094_meta_sync_attribution.sql",
        "server/platform/postgresManualReplyRepository.ts",
