...
const messages: Record<InterfaceLanguage, Messages> = {
  he: {
    ...
    stages: { "awaiting-worker": "ההרשמה נשמרה; ממתין לתחילת הסנכרון ברקע", "awaiting-registration": "ממתין להשלמת הרשמה", "ready-to-request": "בקשות הסנכרון מוכנות", "requesting-contacts": "ממתין לתוצאת בקשת אנשי הקשר",
      ...
      "import-review-required": "החיבור חודש; ייבוא ההיסטוריה דורש בירור שיוך", "awaiting-verification": "הנתונים שהתקבלו עובדו; השלמות טרם אומתה", "sharing-declined": "שיתוף ההיסטוריה נדחה", "recovery-required": "הסנכרון דורש טיפול",
  ...
  en: {
    ...
    stages: { "awaiting-worker": "Onboarding saved; waiting for background synchronization", "awaiting-registration": "Waiting for onboarding", "ready-to-request": "Sync requests prepared", "requesting-contacts": "Waiting for the contacts request result",
      ...
      "import-review-required": "Reconnected; history import needs attribution review", "awaiting-verification": "Received data processed; completeness unverified", "sharing-declined": "History sharing declined", "recovery-required": "Synchronization needs attention",
  ...
  ar: {
    ...
    stages: { "awaiting-worker": "تم حفظ التسجيل؛ في انتظار بدء المزامنة في الخلفية", "awaiting-registration": "بانتظار إكمال التسجيل", "ready-to-request": "طلبات المزامنة جاهزة", "requesting-contacts": "بانتظار نتيجة طلب جهات الاتصال",
      ...
      "import-review-required": "تمت إعادة الاتصال؛ يتطلب استيراد السجل مراجعة المصدر", "awaiting-verification": "تمت معالجة البيانات المستلمة؛ لم يتم التحقق من اكتمالها", "sharing-declined": "تم رفض مشاركة السجل", "recovery-required": "المزامنة تحتاج إلى متابعة",
