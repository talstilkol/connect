...
function parseArguments() {
  ...
  if (
    ...
    throw new Error(
      "usage: node scripts/verify-planning-discovery-cutoff-v3.mjs --verified-at YYYY-MM-DDTHH:mm:ssZ",
    );
  }
  return Object.freeze({
    mode: "create-report",
...
function verifyExistingReport({
  ...
  verifyEnvelope({
    ...
    schema:
      "CONNECT-DISCOVERY-CUTOFF-VERIFICATION-REPORT-ENVELOPE-V3",
    domain:
      "CONNECT.DISCOVERY-CUTOFF-VERIFICATION-REPORT.V3",
  });
  assertExactKeys(
  ...
  if (
    reportEnvelope.payload.schema !==
      "CONNECT-DISCOVERY-CUTOFF-VERIFICATION-REPORT-PAYLOAD-V3" ||
